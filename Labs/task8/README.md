# Отчёт по настройке EIGRP в офисе Санкт-Петербург
...
![На изображении вывод конфигурации](/Labs/task8/pictures/run_eigrp_R16.JPG)
...
![На изображении вывод конфигурации](/Labs/task8/pictures/run_eigrp_R17.JPG)
...
![На изображении вывод конфигурации](/Labs/task8/pictures/run_eigrp_R18.JPG)
...
![На изображении вывод конфигурации](/Labs/task8/pictures/run_eigrp_R32.JPG)
...
![На изображении вывод конфигурации](/Labs/task8/pictures/eigrp_neighbors_R16.JPG)

**R17**

![На изображении вывод конфигурации](/Labs/task8/pictures/eigrp_neighbors_R17.JPG)

**R18**

![На изображении вывод конфигурации](/Labs/task8/pictures/eigrp_neighbors_R18.JPG)

**R32**

![На изображении вывод конфигурации](/Labs/task8/pictures/eigrp_neighbors_R32.JPG)
...
![На изображении вывод конфигурации](/Labs/task8/pictures/ip_route_eigrp_R16.JPG)

![На изображении вывод конфигурации](/Labs/task8/pictures/ip_route_eigrp_R17.JPG)

В данных таблицах видим что **R16** и ***R17** имеют суммарные маршруты, а не подробные сети VLAN.

У  R32 видим только маршрут "0.0.0.0/0" через **R16** по EIGRP.

![На изображении вывод конфигурации](/Labs/task8/pictures/ip_route_R32.JPG)

### Проверяем доступность C VPC8 на Loopback0 R18:

![На изображении вывод конфигурации](/Labs/task8/pictures/ping_VPC8.JPG)
